...
export default function Search({search, setSearch}){
  ...
  return (
    ...
    <label>
    {search ?
    <svg className={styles.clear} onClick={()=>{document.querySelector('input').value = ''; setSearch('')}} width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <input onChange={(a)=> setSearch(a.target.value)} className={styles.input} type="text" placeholder="Поиск пиццы..."/>
    </label>
    </div>
  )
}
